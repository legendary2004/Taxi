        ...
        <div className="relative mx-0 mt-4 flex items-center gap-4 overflow-hidden rounded-xl bg-transparent bg-clip-border pt-0 pb-8 text-gray-700 shadow-none">
          ...
          <div className="flex w-full flex-col gap-0.5">
            <div className="flex items-center justify-between">
              <h5 className="text-xl font-semibold tracking-normal text-gray-900 dark:text-white antialiased">
                Tania Andrew
              </h5>
              <div className="5 flex flex-wrap items-center gap-0">
                <svg
            ...
            <p className="leading-relaxed text-gray-500 antialiased">
              Frontend Lead @ Google
            </p>
          </div>
        </div>
        <div className="mb-6 p-0">
          <p className="text-gray-700 leading-relaxed antialiased dark:text-gray-400">
